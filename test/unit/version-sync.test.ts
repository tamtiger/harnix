...
describe("version sync", () => {
  it("synchronizes package, canonical skills, and one changelog entry idempotently", async () => {
    ...
    await expect(syncVersion({ date: "2026-08-19", root, summaries: ["Đồng bộ release metadata qua script."], version: "1.0.5" })).resolves.toMatchObject({ changed: true, updated: ["README.md"], version: "1.0.5" });
